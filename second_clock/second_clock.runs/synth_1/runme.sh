...
HD_PWD='A:/_important/adjustable_timer/adjustable_timer.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log s_clock.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source s_clock.tcl
