...
HD_PWD='A:/_important/adjustable_timer/adjustable_timer.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log s_clock.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source s_clock.tcl -notrace
