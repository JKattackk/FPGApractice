...
HD_PWD='A:/_important/AdjustableTimerMain/AdjustableTimerMain.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log timerMain.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source timerMain.tcl -notrace
