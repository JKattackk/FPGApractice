...
HD_PWD='A:/_important/AdjustableTimerMain/AdjustableTimerMain.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log timerMain.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source timerMain.tcl
