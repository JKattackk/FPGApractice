...
#set_property -dict { PACKAGE_PIN E18   IOSTANDARD LVCMOS33 } [get_ports { clockTest }]; #IO_L16N_T2_A27_15 Sch=led[2]
...
## RGB LEDs
set_property -dict { PACKAGE_PIN J15   IOSTANDARD LVCMOS33 } [get_ports { stateLED[0] }]; #IO_L23N_T3_FWE_B_15 Sch=led0_r
set_property -dict { PACKAGE_PIN E15   IOSTANDARD LVCMOS33 } [get_ports { stateLED[1] }]; #IO_L15N_T2_DQS_ADV_B_15 Sch=led1_r
## Buttons
set_property -dict { PACKAGE_PIN G15   IOSTANDARD LVCMOS33 } [get_ports { resettimer }]; #IO_L18N_T2_A23_15 Sch=btn[0]
set_property -dict { PACKAGE_PIN K16   IOSTANDARD LVCMOS33 } [get_ports { start }]; #IO_L19P_T3_A22_15 Sch=btn[1]
#set_property -dict { PACKAGE_PIN J16   IOSTANDARD LVCMOS33 } [get_ports { alarm }]; #IO_L19N_T3_A21_VREF_15 Sch=btn[2]
...
#set_property CLOCK_DEDICATED_ROUTE FALSE [get_nets alarm_IBUF] 
